"""
Stage 2, Tier 1 + Tier 2 eval -- "call vs clarify" binary classification.

Extends score_call_vs_clarify.py (Tier 1-only, unchanged, still re-runnable as
its own record) with the two Tier 2 offline-logit-KD checkpoints.
...
Reuses the six checkpoints already trained -- no new training required.
...
Usage:
    python score_call_vs_clarify_tier2.py
"""
import json
import re
